...
import { Loader2, FileText, Printer, Mail, Share2 } from "lucide-react";
                ...
                {finalReport ? (
                  <div className="p-8 h-full max-h-[800px] overflow-y-auto bg-white text-black font-serif leading-relaxed">
                    <div className="mb-12 text-center">
                       ...
                       <p className="text-xs mt-2 italic text-muted-foreground">Generated by VisionaryGPT on {new Date().toLocaleDateString()}</p>
                    </div>
